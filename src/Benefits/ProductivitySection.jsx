...
import inspirationPic1 from "../assets/Benefits-assets/inspirationPic1.svg";
...
import thumbsupEmoji from "../assets/thumbsup-emoji.svg";
  ...
  return (
    <div className="py-10 lg:py-20">
      ...
      <div className="flex flex-col items-center justify-center gap-y-3.5">
        <div className="flex items-center justify-center rounded-full bg-[#D3E763] text-black border border-[#506F6F] py-[3px] px-2 lg:px-4 lg:py-1.5 font-semibold text-[10px] lg:text-xs">
      ...
      <div className="py-14 lg:py-24 p-7 flex justify-center flex-col gap-y-4 lg:flex xl:flex-row gap-x-10 lg:items-center">
        ...
        <div className="flex flex-col md:flex-row xl:flex-col md:gap-x-5 md:mx-auto xl:mx-0 xl:gap-x-0 gap-y-4 lg:gap-y-10">
          <div className="glowing-background">
            <div className="flex items-center ju gap-x-5 pb-10 p-5">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-sm text-[#C8C9D0]/20 font-[400]">
                  moana_j@mail.com
                </p>
              </div>
            </div>
            <div className="flex items-center gap-x-10 border-t border-slate-500/20">
              <div className="flex flex-col justify-start py-5 px-5">
                <h3 className="text-lg text-[#C8C9D0] font-[400]">
                  12 sep 2002
                </h3>
                <p className="text-[#868898] text-sm font-[400]">Join date</p>
              </div>
              <div className="flex flex-col justify-start">
                <h3 className="text-lg text-[#C8C9D0] font-[400]">
                  42 projects
                </h3>
                <p className="text-[#868898] text-sm font-[400]">Reviews</p>
              </div>
            </div>
          </div>
